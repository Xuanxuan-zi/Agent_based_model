...
class SugarScapeModel(mesa.Model):
    ...
    def __init__(
        ...
        # ============================================================
        # >>> MY MODIFICATION #5: Tuned default parameters <<<
        # ============================================================
        # Motivation: With original defaults (endowment 25-50, metabolism 1-5),
        # the average agent lifespan was ~12.5 steps. This was too short for
        # my boredom mechanism (threshold 2-4 steps) to produce observable
        # effects across the population.
        #
        # Balance goal: Make agents live long enough for boredom to matter,
        # but not so long that overcrowding breaks the simulation.
        #
        # Changes:
        #   endowment_min:  25 -> 40   (agents start with more sugar)
        #   endowment_max:  50 -> 80   (upper bound raised proportionally)
        #   metabolism_max:  5 -> 4    (slower sugar burn rate)
        #
        # Result: Average lifespan ~20-25 steps, boredom triggers reliably,
        # but grid does not become dangerously overcrowded.
        endowment_min=40,      # MODIFIED: was 25
        endowment_max=80,      # MODIFIED: was 50
        metabolism_min=1,
        metabolism_max=4,      # MODIFIED: was 5
        # ============================================================
